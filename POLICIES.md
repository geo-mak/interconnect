...
During that time I was continuously experimenting with the idea and writing prototypes in my free time using Python, until I reached a point where I have decided that this language is a dead end and switching now is better than reimplementing later, and this was where I decided to roll up my sleeves, or more accurately, to take off my clothes and swim into the deep water of Rust and its libraries in a very serious and dedicated way. Other language like C/C++ were too old and messy to my taste, other newer languages were too unstable and less satisfying in terms of taste.
